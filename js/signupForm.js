...
const saveRegis = (email, nombre, apellidoPaterno, apellidoMaterno, pass) =>
  addDoc(collection(db,"registro"), {email, nombre, apellidoPaterno, apellidoMaterno, pass});
...
signUpForm.addEventListener("submit", async (e) => {
  ...
  try {
    if (password === confirmation) {
      const registro = await saveRegis (email, nombre, apellidoPaterno, apellidoMaterno, password )
